namespace Fmpostor.Api.Config
{
    public static class DisconnectMessages
    {
        ...
        public const string VersionServerTooOld = "Your client is too new, please update your Fmpostor server to play.";

        public const string VersionUnsupported = "Your client version is unsupported, please update your Game and/or Fmpostor server.";
        ...
        public const string HostAuthorityUnsupported = "Your client is requesting host authority, which is not enabled on this Fmpostor server.";
    }
}
