...
namespace Fmpostor.Api.Net.Inner.Objects
{
    public interface IInnerPlayerControl : IInnerNetObject
    {
        ...
        /// <exception cref="FmpostorProtocolException">Thrown when player doesn't have a PlayerInfo.</exception>
        ...
        /// <exception cref="FmpostorProtocolException">Thrown when player is not the impostor.</exception>
        /// <exception cref="FmpostorProtocolException">Thrown when player is dead.</exception>
        /// <exception cref="FmpostorProtocolException">Thrown when target is dead.</exception>
        /// <exception cref="FmpostorProtocolException">Thrown when player or target player doesn't have a PlayerInfo.</exception>
        /// <returns>Task that must be awaited.</returns>
        ...
        ///     Visible to all players.
        /// </summary>
        /// <exception cref="FmpostorProtocolException">Thrown if player to be exiled is already dead.</exception>
        /// <exception cref="FmpostorProtocolException">Thrown when player or target player doesn't have a PlayerInfo.</exception>
        /// <returns>Task that must be awaited.</returns>
