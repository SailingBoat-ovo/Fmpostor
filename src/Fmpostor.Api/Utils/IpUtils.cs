        ...
        public static string ResolveIp(string ip)
        {
            ...
            if (!IPAddress.TryParse(ip, out var ipAddress))
            {
                ...
                try
                {
                    ...
                    {
                        throw new FmpostorConfigException($"Invalid IP Address entered '{ip}'.");
                    }
                ...
                {
                    throw new FmpostorConfigException($"Failed to resolve hostname '{ip}'.");
                }
            }
            ...
            {
                throw new FmpostorConfigException($"Invalid IP Address entered '{ipAddress}', only IPv4 is supported by Among Us.");
            }
