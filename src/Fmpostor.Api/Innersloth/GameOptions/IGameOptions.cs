...
public interface IGameOptions
{
    ...
    public static void EnsureVersionIsModular<TCaller>(byte version)
    {
        ...
        {
            throw new FmpostorException($"{typeof(TCaller).Name} didn't exist before version 7, did you mean {nameof(LegacyGameOptionsData)}?");
        }
    }
    ...
    {
        throw new FmpostorException($"Unknown {typeof(TCaller).Name} version {version}");
    }
}
