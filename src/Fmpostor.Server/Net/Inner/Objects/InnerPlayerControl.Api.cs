...
namespace Fmpostor.Server.Net.Inner.Objects
{
    internal partial class InnerPlayerControl : IInnerPlayerControl
    {
        ...
        public async ValueTask SetNameAsync(string name)
        {
            if (PlayerInfo == null)
            {
                throw new FmpostorProtocolException("Cannot set name, PlayerInfo is null");
            }
        ...
        public async ValueTask SetColorAsync(ColorType color)
        {
            if (PlayerInfo == null)
            {
                throw new FmpostorProtocolException("Cannot set color, PlayerInfo is null");
            }
        ...
        public async ValueTask SetHatAsync(string hatId)
        {
            if (PlayerInfo == null)
            {
                throw new FmpostorProtocolException("Cannot set hat, PlayerInfo is null");
            }
        ...
        public async ValueTask SetPetAsync(string petId)
        {
            if (PlayerInfo == null)
            {
                throw new FmpostorProtocolException("Cannot set pet, PlayerInfo is null");
            }
        ...
        public async ValueTask SetSkinAsync(string skinId)
        {
            if (PlayerInfo == null)
            {
                throw new FmpostorProtocolException("Cannot set skin, PlayerInfo is null");
            }
        ...
        public async ValueTask SetVisorAsync(string visorId)
        {
            if (PlayerInfo == null)
            {
                throw new FmpostorProtocolException("Cannot set visor, PlayerInfo is null");
            }
        ...
        public async ValueTask SetNamePlateAsync(string nameplateId)
        {
            if (PlayerInfo == null)
            {
                throw new FmpostorProtocolException("Cannot set nameplate, PlayerInfo is null");
            }
        ...
        public async ValueTask MurderPlayerAsync(IInnerPlayerControl target, MurderResultFlags result)
        {
            ...
            {
                throw new FmpostorProtocolException(reason);
            }
        ...
        public async ValueTask ProtectPlayerAsync(IInnerPlayerControl target)
        {
            ...
            {
                throw new FmpostorProtocolException("Tried to exile a player, but target didn't have a playerinfo");
            }
            else if (target.PlayerInfo.IsDead)
            {
                throw new FmpostorProtocolException("Tried to protect a player that is dead");
            }
        ...
        public async ValueTask ExileAsync()
        {
            ...
            {
                throw new FmpostorProtocolException("Tried to exile a player, but target was not alive.");
            }
