...
namespace Fmpostor.Server.Net.State
{
    internal partial class Game
    {
        ...
        /// <summary>
        ///     Optional preferred host used by <see cref="Game.State.MigrateHost" />
        ///     (set by the host-transfer feature /nexthost). Reset after use.
        /// </summary>
        public int? PreferredHostId { get; set; }
